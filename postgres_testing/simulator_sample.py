from Simulator import plenario2expand_geog, plenario2narrow_geog, input_global_variables, plenario2user_login
import time
import random
import psycopg2
...
# This function is written in Simulator, to login to postgres
plenario2user_login(dbname, username)
